...
txt = []
tb = lambda : TextBox(screen, 260, 0, 200, 20, fontSize=10)
sliders = {
	"x-axis": (Slider(screen, 60, 0, 220, 10, min=-20, max=20, step=.1), tb()),
	"y-axis": (Slider(screen, 60, 0, 220, 10, min=-20, max=20, step=.1), tb()),
	"z-axis": (Slider(screen, 60, 0, 220, 10, min=-20, max=20, step=.1), tb()),
	"roll": (Slider(screen, 60, 0, 220, 10, min=-20, max=20, step=.1), tb()),
	"pitch": (Slider(screen, 60, 0, 220, 10, min=-20, max=20, step=1), tb()),
	"yaw": (Slider(screen, 60, 0, 220, 10, min=-20, max=20, step=.1), tb()),
}
