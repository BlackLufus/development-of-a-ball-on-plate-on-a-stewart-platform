...
from src.ball_on_plate.rl.v4.simulation import environment
...
if __name__ == "__main__":
    env_id = 'BallOnPlate-v4'
    dir = "4_0" # Use version number as dir name
    ...
    run_sb3(env_id, dir, model_name, sb3_model="ppo", render_fps=13)
