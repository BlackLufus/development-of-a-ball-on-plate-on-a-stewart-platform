...
def run_sb3(env_id, id, model_name, sb3_model, device='cpu', iterations=10, simulation_mode=False, render_fps=32, logger: logging=None):
    logger = logger or logging.getLogger(__name__)

    env = gym.make(env_id, simulation_mode=simulation_mode, render_fps=render_fps)
