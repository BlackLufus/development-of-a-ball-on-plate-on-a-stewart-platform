...
class VacuumRobot:
    ...
    def __init__(self, grid_rows=5, grid_cols=5, n_dirt=12, fps=1):
    ...
    def _init_robot_position(self):
        ...
        self.robot_station_pos = new_pos.copy()
    ...
    def _init_target_position(self):
        ...
        while len(self.dust_list) < self.n_dirt:
            ...
            if new_pos not in self.dust_list and new_pos not in self.wall_list and new_pos != self.robot_pos:
    ...
    def perform_action(self, robot_action:RobotAction) -> bool:
        ...
        if robot_action == RobotAction.SUCK:
            ...
            if new_pos not in self.wall_list:
                self.robot_pos = new_pos

        all_cleaned = len(self.dust_list) == 0
        job_finished = all_cleaned and self.robot_pos == self.robot_station_pos

        return dirt_cleaned, all_cleaned, job_finished
